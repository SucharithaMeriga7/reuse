/*==============================================================
 ...
 Purpose          : Incremental SCD Type 1 pipeline from AEROSPACE_PARTS_SOURCE
                    ...
                    soft delete, and ETL_RECONCILIATION_LOG
...
DECLARE
    ...
    v_pipeline_start          TIMESTAMP_NTZ;                                   -- [DELTA ADD] Pipeline start timestamp for SLA duration tracking
    ...
    v_execution_duration      NUMBER         DEFAULT 0;                        -- [DELTA ADD] Execution duration seconds for SLA compliance logging
BEGIN

    v_pipeline_start := CURRENT_TIMESTAMP();                                   -- [DELTA ADD] Capture pipeline start time (AC-008: SLA 5-min enforcement)
    ...
    WHEN NOT MATCHED THEN INSERT (
        ...
        SUPPLIER_ID, UPDATED_AT, RISK_SCORE, LOAD_TIMESTAMP, PART_STATUS
    ) VALUES (
        ...
        src.SUPPLIER_ID, src.UPDATED_AT, src.RISK_SCORE, src.LOAD_TIMESTAMP, 'Active'
    );
    ...
    v_execution_duration := DATEDIFF('second', :v_pipeline_start, CURRENT_TIMESTAMP());  -- [DELTA ADD] Compute SLA duration (BRD NFR-001: 5 min / 1M records)
    ...
    RETURN 'SUCCESS: Mode=' || :v_load_mode
        ...
        || ' | Duration(s)='    || :v_execution_duration::VARCHAR;             -- [DELTA ADD] Duration in return message for SLA visibility
...
EXCEPTION WHEN OTHER THEN
    INSERT INTO IDEA_2_DB.PUBLIC.ETL_RECONCILIATION_LOG (
        ...
        DATEDIFF('second', :v_pipeline_start, CURRENT_TIMESTAMP())             -- [DELTA ADD] Duration on failure path for SLA breach diagnosis
    );
