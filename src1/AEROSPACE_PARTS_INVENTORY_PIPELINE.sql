...
-- Purpose     : Incremental SCD Type 1 ETL pipeline — AEROSPACE_PARTS_SOURCE to AEROSPACE_PARTS_TARGET.
--               Supports full and incremental load modes with deduplication, UPPER transformation,
--               WEIGHT_KG sentinel replace, RISK_SCORE derivation, PART_CATEGORY direct copy,
--               soft delete (Decommissioned), and mandatory reconciliation logging.
-- Author      : SUCHARITHAS
-- Generated   : 2026-09-24
-- [DELTA REFERENCE] Adapted from: AEROSPACE_PARTS_INVENTORY_PIPELINE (Object Registry, 73% match)
-- ============================================================
...
BEGIN
    ...
    WHEN NOT MATCHED THEN INSERT (
        ...
        UNIT_PRICE_USD, STOCK_QUANTITY, SUPPLIER_ID,
        UPDATED_AT, RISK_SCORE, RECORD_STATUS, ETL_LOAD_TIMESTAMP
    ) VALUES (
        ...
        src.UNIT_PRICE_USD, src.STOCK_QUANTITY, src.SUPPLIER_ID,
